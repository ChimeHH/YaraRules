...
rule Prime_Constants_char : crypto {
	meta:
		author = "_pusher_"
...
rule Prime_Constants_long : crypto {
	meta:
		author = "_pusher_"
...
rule Crypt32_CryptBinaryToString_API : crypto  {
	meta:
		author = "_pusher_"
...
rule CRC32c_poly_Constant : crypto  {
	meta:
		author = "_pusher_"
...
rule CRC32_poly_Constant : crypto  {
	meta:
		author = "_pusher_"
...
rule CRC32_table_lookup : crypto  {
	meta:
		author = "_pusher_"
...
rule CRC32b_poly_Constant : crypto  {
	meta:
		author = "_pusher_"
...
rule FlyUtilsCnDES_ECB_Encrypt : crypto  {
	meta:
		author = "_pusher_"
...
rule FlyUtilsCnDES_ECB_Decrypt : crypto  {
	meta:
		author = "_pusher_"
...
rule CryptoPP_a_exp_b_mod_c : crypto
{	meta:
		author = "Maxx"
...
rule FGint_MontgomeryModExp : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
		version = "0.2"
...
rule FGint_FGIntDestroy : crypto
{	meta:
		author = "_pusher_"
		date = "2015-05"
...
rule FGint_Base10StringToGInt : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
		version = "0.2"
...
rule FGint_ConvertBase256to64 : crypto
{	meta:
		author = "_pusher_"
		date = "2015-05"
...
rule FGint_ConvertHexStringToBase256String : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
		version = "0.2"
...
rule FGint_Base256StringToGInt : crypto
{	meta:
		author = "_pusher_"
		date = "2015-05"
...
rule FGint_FGIntToBase256String : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
		version = "0.2"
...
rule FGint_ConvertBase256StringToHexString : crypto
{	meta:
		author = "_pusher_"
		date = "2015-05"
...
rule FGint_PGPConvertBase256to64 : crypto
{	meta:
		author = "_pusher_"
		date = "2016-08"
...
rule FGint_FindPrimeGoodCurveAndPoint : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
...
rule FGint_ECElGamalEncrypt : crypto
{	meta:
		author = "_pusher_"
		date = "2016-08"
...
rule FGint_ECPointKMultiple : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
...
rule FGint_ECPointDestroy : crypto
{	meta:
		author = "_pusher_"
		date = "2015-06"
...
rule FGint_DSAPrimeSearch : crypto
{	meta:
		author = "_pusher_"
		date = "2016-08"
...
rule OpenSSL_BN_mod_exp2_mont : crypto
{	meta:
		author = "Maxx"
...
rule OpenSSL_BN_mod_exp_mont : crypto
{	meta:
		author = "Maxx"
...
rule OpenSSL_BN_mod_exp_recp : crypto
{	meta:
		author = "Maxx"
...
rule OpenSSL_BN_mod_exp_simple : crypto
{	meta:
		author = "Maxx"
...
rule OpenSSL_BN_mod_exp_inverse : crypto
{	meta:
		author = "Maxx"
...
rule LockBox_RsaEncryptFile : crypto
{	meta:
		author = "Maxx"
...
rule LockBox_DecryptRsaEx : crypto
{	meta:
		author = "Maxx"
...
rule LockBox_EncryptRsaEx : crypto
{	meta:
		author = "Maxx"
...
rule CryptoPP_ApplyFunction : crypto
{	meta:
		author = "Maxx"
...
rule CryptoPP_RsaFunction : crypto
{	meta:
		author = "Maxx"
...
rule CryptoPP_Integer_constructor : crypto
{	meta:
		author = "Maxx"
...
rule RijnDael_AES_CHAR_inv : crypto
{	meta:
		author = "_pusher_"
...
rule RsaRef2_NN_modMult : crypto
{	meta:
		author = "Maxx"
...
rule RsaRef2_RsaPrivateDecrypt : crypto
{	meta:
		author = "Maxx"
...
rule RsaRef2_RsaPrivateEncrypt : crypto
{	meta:
		author = "Maxx"
...
rule RsaRef2_RsaPublicDecrypt : crypto
{	meta:
		author = "Maxx"
...
rule RsaRef2_RsaPublicEncrypt : crypto
{	meta:
		author = "Maxx"
...
rule RsaEuro_NN_modMult : crypto
{	meta:
		author = "Maxx"
...
rule Miracl_Big_constructor : crypto
{	meta:
		author = "Maxx"
...
rule Miracl_mirsys_init : crypto
{	meta:
		author = "Maxx"
...
rule x509_public_key_infrastructure_cert : crypto
{	meta:
...
rule pkcs8_private_key_information_syntax_standard : crypto
{	meta:
...
rule Delphi_RandomRange : crypto {
	meta:
		author = "_pusher_"
...
rule Delphi_CompareCall : crypto {
	meta:
		author = "_pusher_"
...
rule DCP_RIJNDAEL_EncryptECB : crypto {
	meta:
		author = "_pusher_"
...
rule DCP_BLOWFISH_EncryptCBC : crypto {
	meta:
		author = "_pusher_"
...
rule DCP_DES_EncryptECB : crypto {
	meta:
		author = "_pusher_"
...
rule Chacha_128_constant : crypto {
    meta:
		author = "spelissier"
...
rule Chacha_256_constant : crypto {
    meta:
		author = "spelissier"
...
rule SipHash_big_endian_constants : crypto {
    meta:
		author = "spelissier"
